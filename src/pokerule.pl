...
% Pokemon P have the best move M beat Pokemon Enemey E if Pokemon P have Move M ,Pokemon P have typ T,
% Move M have Type T1  and Pokemon Enemey E have Type T2 and T1 effective T2 with R >= 2 and T resistance T2 and
% Pokemon P can fight with Pokemon E.
pokerule:beat(P,M,E):-
  pokefact:pokemon(P),
  best_move(P,M),
...
% pokemon P have best move if pokemon P have Move M1 and M1 is attack move that not have other move and type more power than M1.
...
% attack move M if move M have power damage is not 0.
...
% any Attack Type Attack effective_ratio  with [Defense | Defense2 ]  is Ratio if Defense not is Defense2 and Attack effective Defense is Ratio1 and Attack effective_ratio Defense2 is Ratio2 and Ratio is Raitio1 * Ratio2.
